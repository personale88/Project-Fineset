  ...
  admin: {
    ...
    billing: {
      ...
      followUp: {
        ...
        markedPaidConfirmationWarning: "Marked as paid, but the confirmation email could not be sent.",
    ...
    automation: {
      ...
      saveConflict:
        "These settings were changed elsewhere. Refresh the page and try again.",
      timezoneDriftWarning:
        "Automation timezone ({automationTz}) differs from platform default ({platformTz}). Saving platform settings syncs automation, or update automation timezone here.",
      ...
      runPartialSuccess: "Automation run finished with some errors.",
      runDryRunSuccess: "Dry run completed — no messages were sent.",
      runFailed: "Automation run failed.",
      dryRunForcedWarning:
        "Dry run mode is on — no emails or messages were sent despite Run Now.",
      runSummary:
        "{invoices} invoices · {reminders} reminders · {whatsapp} WhatsApp · {renewals} renewals · {expiry} expiry · {reports} reports · {followUps} follow-ups",
      scope: {
        overview: "Overview",
      ...
      fields: {
        ...
        sendOnRenewalDue: "Send on renewal due",
        sendOnRenewalDueHint: "Also send invoice when renewal date arrives.",
        ...
        stopAfterPayment: "Stop reminders after payment",
        stopAfterPaymentHint: "Skip reminders when the account is paid or waived this cycle.",
        ...
        escalateAfterMaxHint: "Log accounts for manual review once follow-ups are exhausted.",
        ...
        autoExtendOnPayment: "Extend renewal on payment",
        autoExtendOnPaymentHint: "Push renewal and data-expiry dates when payment is recorded.",
        ...
        includeBillingSummaryHint: "MRR, at-risk MRR, unpaid counts, and status breakdown.",
      ...
      history: {
        ...
        loadFailed: "Could not load automation run history.",
        loadMore: "Load more",
        running: "Running",
        summaryLine:
