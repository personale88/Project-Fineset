export const content = {
  ...
  visitForm: {
    ...
    location: {
      ...
      denied: "Unable to detect your location. Please enable GPS and try again.",
      unavailable: "GPS is unavailable on this device. Enable location services and try again.",
      poorAccuracy: "GPS signal is weak (±{meters} m). Move to an open area and retry.",
      retry: "Retry location",
      accuracyLabel: "GPS uncertainty (±)",
      capturedAtLabel: "Captured at",
      resolvingAddress: "Looking up street address…",
      addressUnavailable: "Address could not be resolved. Coordinates will still be saved.",
      ...
      stateLabel: "State",
      requiredHint: "GPS is required to verify you are at the store when submitting.",
      submitBlocked: "Enable GPS and detect your location before submitting.",
      exception: {
        title: "Manager GPS exception active",
        description: "Your manager approved a one-time submit without GPS for this form.",
        expiresLabel: "Valid until {time}",
      },
    },
    actions: {
      submit: "Submit Visit",
  ...
  fieldSalesForm: {
    ...
    location: {
      title: "Your location",
      detecting: "Fetching your current location from this device…",
      detected: "Current location captured. It will be saved with this field sale.",
      denied: "Location access was blocked. Allow location in your browser and retry.",
      unavailable: "Could not read location on this device. Enable location services and retry.",
      poorAccuracy: "GPS signal is weak (±{meters} m). Move to an open area and retry.",
      retry: "Refresh location",
      accuracyLabel: "GPS uncertainty (±)",
      capturedAtLabel: "Captured at",
      resolvingAddress: "Looking up street address…",
      addressUnavailable: "Address could not be resolved. Coordinates will still be saved.",
      ...
      districtLabel: "District",
      stateLabel: "State",
      requiredHint: "Your browser location is recorded automatically while you complete this form.",
      submitBlocked: "Allow location access and wait for your address before submitting.",
      exception: {
        title: "Manager GPS exception active",
        description: "Your manager approved a one-time submit without GPS for this form.",
        expiresLabel: "Valid until {time}",
  ...
  admin: {
    ...
    settings: {
      ...
      scope: {
        ...
        fieldForce: "Field force GPS",
        fieldForceHint:
          "Require GPS verification when staff log field sales and tune accuracy rules.",
      },
      fields: {
        ...
        requireGpsForFieldSales: "Require GPS for field sales",
        requireGpsForFieldSalesHint:
          "Staff must capture a fresh GPS reading before submitting a field sale log.",
        allowSubmitWithoutGps: "Allow submit without GPS",
        allowSubmitWithoutGpsHint:
          "When enabled, staff can submit even if GPS is denied or unavailable (audit trail still records status).",
        maxAccuracyMeters: "Sharp GPS threshold (meters)",
        maxAccuracyMetersHint:
          "Readings with GPS uncertainty above this are marked coarse but still saved (default 50 m). This is signal quality, not distance from the store.",
        maxLocationAgeSeconds: "Max location age (seconds)",
        maxLocationAgeSecondsHint:
          "Reject GPS readings older than this many seconds at submit time (default 120).",
        requireGpsForVisits: "Require GPS for visit logs",
        requireGpsForVisitsHint:
          "Staff must capture GPS when logging in-store customer visits.",
      },
      categories: {
    ...
    accounts: {
      ...
      editModal: {
        ...
        geofenceSectionTitle: "Store geofence (GPS)",
        geofenceSectionHint:
          "Set the store HQ coordinates and radius used to flag field logs outside the approved area.",
        latitudeLabel: "Latitude",
        longitudeLabel: "Longitude",
        geofenceRadiusLabel: "Geofence radius (meters)",
        geofenceRadiusHint: "Leave blank to disable geofence checks for this store.",
      },
      deleteModal: {
        title: "Delete store",
        description:
  ...
  portal: {
    ...
    fieldSales: {
      ...
      locationStatusLabel: "GPS status",
      locationStatusAll: "All GPS statuses",
      outsideAreaOnly: "Outside approved area only",
      issueGpsException: {
        trigger: "Issue GPS exception",
        title: "Approve GPS exception",
        description:
          "Allow a staff member to submit one field log or visit without GPS. Valid for 2 hours and single use.",
        staffLabel: "Staff member",
        recordTypeLabel: "Applies to",
        recordTypes: {
          fieldSale: "Field sale log",
          visit: "Visit log",
        },
        reasonLabel: "Reason (optional)",
        reasonPlaceholder: "e.g. Indoor event, GPS unavailable on device",
        submit: "Issue exception",
        submitting: "Issuing…",
        success: "GPS exception issued.",
        failed: "Could not issue GPS exception.",
      },
    },
  },
} as const;
